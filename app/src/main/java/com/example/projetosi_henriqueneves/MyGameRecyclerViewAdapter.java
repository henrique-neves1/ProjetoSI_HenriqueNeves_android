...
import com.example.projetosi_henriqueneves.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.projetosi_henriqueneves.databinding.FragmentGameBinding;
...
public class MyGameRecyclerViewAdapter extends RecyclerView.Adapter<MyGameRecyclerViewAdapter.ViewHolder> {
    ...
    public MyGameRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
